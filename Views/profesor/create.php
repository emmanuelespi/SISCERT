        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <strong>Agregar </strong> Profesor
                    <a href="?controller=profesor&method=show" class="btn btn-outline-primary">Volver</a>
                </div>
                <div class="card-body card-block">
                    <form action="?controller=profesor&method=store" method="post" class="form-horizontal">
