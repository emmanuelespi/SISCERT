        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">SISCERT </a>
            ...
            <div class="top-right">
                <div class="header-menu">
                     <p class="navbar-text">Bienvenido: [ <?= $_SESSION['user']->usuario;?> ]    |    </p>
                    <a href="?controller=security&method=logout" class="nav-link text-danger"> <i class="fa fa-power-off"></i> Cerrar sesión</a>
                </div>
            </div>
        </header>
        <!-- /#header -->
